package com.sda.georgianamunteanu.advanced.coding.collections.ex8;

import java.util.LinkedList;

/**
 * Ex 8Create a class imitating a weapon magazine.
...
public class WeaponMagazine {
    ...
    public void loadBullet(String bullet) {
        if (bullets.size() < maxSize) {
            ...
            System.out.println("Max size 8" + maxSize + " reached !");
